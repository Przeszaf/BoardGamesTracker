//
//  CellBackgroundHighlightView.swift
//  BoardGamesTracker
//
...
class CellBackgroundHighlightView: UIView {
    ...
    func setup() {
        ...
        gradient.colors = [Constants.Cell.gradientHighlightStartColor, Constants.Cell.gradientHighlightEndColor]
