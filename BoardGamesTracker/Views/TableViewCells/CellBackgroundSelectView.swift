//
//  CellBackgroundSelectView.swift
//  BoardGamesTracker
//
...
class CellBackgroundSelectView: UIView {
    ...
    func setup() {
        ...
        gradient.colors = [Constants.Cell.gradientSelectStartColor, Constants.Cell.gradientSelectEndColor]
